...
public class StockroomOperationsTest {
    ...
    public void insertDistrict_OnlyOne() {
        int rowId = stockroomOperations.insertDistrict(insertSampleDistrict());
        List<Integer> list = stockroomOperations.getAllStockrooms();
        Assert.assertEquals(1, list.size());
    ...
    public void insertDistrict_TwoStockrooms_SameAddress() {
        int idAddress = insertSampleDistrict();
    ...
    public void insertDistrict_TwoStockrooms_SameCity() {
        ...
        int idAddress1 = insertSampleDistrict(idCity);
        int idAddress2 = insertSampleDistrict(idCity, "Knez Mihajlova", 23, 79, 52);
    ...
    public void insertDistrict_MultipleStockrooms() {
        ...
        int idAddress1 = insertSampleDistrict(idCity1);
        int idAddress2 = insertSampleDistrict(idCity2, "Wall Street", 789, -4897, -89);
    ...
    public void deleteDistrict_WithId_OnlyOne() {
        Assert.assertTrue(stockroomOperations.deleteDistrict(
                stockroomOperations.insertDistrict(insertSampleDistrict())));
